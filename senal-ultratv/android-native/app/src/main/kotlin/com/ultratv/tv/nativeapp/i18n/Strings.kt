...
private val EN = Strings(
    ...
    homeWelcome = "Bienvenido a SEÑAL",
    ...
    wizardWelcomeTitle = "👋 Bienvenido a SEÑAL",
    wizardAddProviderTitle = "📡 Add a provider",
    wizardDoneTitle = "🎉 You're set",
    wizardStepTemplate = "Step %1\$d / %2\$d",
    wizardIntro1 = "SEÑAL conecta con tu servidor. Tras el login carga downloads/lista.m3u automáticamente.",
    wizardIntro2 = "Usa Compose-TV, Media3 y tu lista del VPS. Navegación con el mando.",
    ...
    prefLaunchAtBootHint = "Abrir SEÑAL al encender la TV.",

...
object UltraTokens {
    // Accent
    val Accent       = Color(0xFF2EC6E0)
    val Accent2      = Color(0xFF5AD4EA)
    val AccentGlow   = Color(0x8C2EC6E0)
    val AccentSoft   = Color(0x242EC6E0)  // ~14% — pill highlights
    val AccentTint   = Color(0x1A2EC6E0)  // ~10% — gradient stops

...
internal fun LazyListScope.settingsAboutSection(
    ...
    item {
        ...
        SettingsRow(label = "Credits", value = stringResource(R.string.based_on_streamvault))
        SettingsRow(label = "StreamVault", value = stringResource(R.string.streamvault_github))
        SettingsRow(label = "Ko-fi", value = stringResource(R.string.streamvault_kofi))

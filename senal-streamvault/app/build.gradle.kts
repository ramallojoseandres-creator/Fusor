...
android {
    ...
    defaultConfig {
        ...
        // SEÑAL panel — login + auto playlist from server
        buildConfigField("String", "SENAL_BASE_URL", "\"http://185.192.20.245:3000\"")
        buildConfigField("String", "SENAL_PLAYLIST_URL", "\"http://185.192.20.245:3000/playlist.m3u\"")
        buildConfigField("String", "SENAL_PLAYLIST_NAME", "\"SEÑAL\"")
        buildConfigField("boolean", "SENAL_HIDE_PLUGINS", "true")
        buildConfigField("boolean", "SENAL_HIDE_DOWNLOADS", "true")

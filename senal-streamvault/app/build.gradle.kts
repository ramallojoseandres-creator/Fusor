...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "OFFICIAL_APPLICATION_ID", "\"com.senal.v1\"")
        ...
        // SEÑAL v1: M3U/link only (no panel login yet). Prefill helps first test.
        buildConfigField("boolean", "SENAL_M3U_ONLY", "true")
        buildConfigField("String", "SENAL_DEFAULT_M3U_URL", "\"http://185.192.20.245:3000/downloads/lista.m3u\"")
        buildConfigField("String", "SENAL_DEFAULT_M3U_NAME", "\"SEÑAL\"")
        ndk {
